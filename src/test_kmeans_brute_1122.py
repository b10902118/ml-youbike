...
for grp_id in sorted(t_df["group"].unique()):
    ...
    mean_of_mean = group_df.loc[grp_id]["mean_of_mean"]
    print(
        f"group {grp_id}, {best_sbi = }, {err = }, {mean_of_mean = }",
    )
...
MAE 5.033622094671202
Score 0.3445006835953285

with brute (500):

MAE 5.000230300453515
Score 0.34192574027476547

with brute (100):

MAE 5.099082341269841
Score 0.35062542818135534
"""
...
out_df.to_csv("public_test_submission_1122_0008.csv", index=False)
